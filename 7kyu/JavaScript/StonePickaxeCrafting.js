...
// 3 cobblestones, 2 sticks needed
const stonePick = arr => {
  let cobblestones = arr.filter(i => i === 'Cobblestone').length;
  let sticks = arr.filter(i => i === 'Sticks').length;
  let wood = arr.filter(i => i === 'Wood').length;
  sticks += wood * 4;
