...
const squeakyClean = a => {
  // array of invalid input
  const invalidInput = ['', 0, undefined, null]
  // filter array so only valid elements are in new array
  return a.filter(e => !invalidInput.includes(e))
}
