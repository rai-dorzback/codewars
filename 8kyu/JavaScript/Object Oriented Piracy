...
class Ship {
  ...
  isWorthIt() {
    const draftMinusCrew = this.draft - (this.crew * 1.5)
    return draftMinusCrew > 20 ? true : false
  }
  
}

// METHOD 2: arrow function, ternary
class Ship {
  constructor(draft, crew) {
    this.draft = draft
    this.crew = crew
  ...
  isWorthIt = () => this.draft - (this.crew * 1.5) > 20 ? true : false 
}
