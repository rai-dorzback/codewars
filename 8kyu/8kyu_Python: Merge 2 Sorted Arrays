...
# METHOD 2: use lambda function with parameters arr1 and arr 2. return a sorted set of the concatenated arrays. using set makes it so there are only unique values
