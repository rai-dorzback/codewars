...
// filter for only numbers, this function will be called in all other filters
const numsOnly = arr => arr.filter(e => Number.isInteger(e))

Array.prototype.even = function(){
  return numsOnly(this).filter(e => e % 2 === 0)
}
...
Array.prototype.under = function(x){
  return numsOnly(this).filter(e => e < x)
}
...
Array.prototype.inRange = function(min,max){
  return numsOnly(this).filter(e => e >= min && e <= max)
}
